...
const projects = [
  { title: 'High-Rise Commercial Tower', image: '/projects/project1.jpg' },
  { title: 'Modern Residential Estate', image: '/projects/project2.jpg' },
  { title: 'Bridge Infrastructure Build', image: '/projects/project3.jpg' },
  { title: 'Industrial Plant Facility', image: '/projects/project4.jpg' },
];
            ...
            <div className="max-w-[1600px] mx-auto grid md:grid-cols-4 gap-12">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#projects" className="hover:underline  text-orange-400">Projects</a></li>
