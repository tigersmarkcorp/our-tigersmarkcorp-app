...
const coreValues = [
  {
    ...
    icon: <HomeIcon size={56} className="mb-4 mx-auto text-[#f59e0b]" />,
  },
  {
    title: 'EXCELLENCE',
    desc: 'We are committed to delivering unparalleled quality in every aspect of our work.',
    icon: <Building2 size={56} className="mb-4 mx-auto text-[#f59e0b]" />,
  },
  {
    title: 'INNOVATION',
    desc: 'We cultivate creativity and embrace forward-thinking solutions to lead the industry.',
    icon: <ClipboardList size={56} className="mb-4 mx-auto text-[#f59e0b]" />,
  },
];
...
export default function AboutUsSection() {
  ...
  // Cleaned links — no trailing spaces
  const links = [
    ...
    { icon: <FaMapMarkerAlt />, href: 'https://goo.gl/maps/yourlocation', bg: 'bg-emerald-700', label: 'Location' },
  ];
      ...
      <section id="Home" className="relative w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-black text-white mb-6 leading-tight tracking-tighter drop-shadow-2xl">
            <span className="text-[#f59e0b]">Tiger’s Mark</span> <br />
            Builds Tomorrow
          </h1>
      ...
      <section className="relative px-6 md:px-12 lg:px-24 py-32 space-y-40">
        ...
        >
          <div className="space-y-7 order-2 lg:order-1">
            ...
            <div className="w-20 h-1 bg-[#f59e0b] rounded-full"></div>
          </div>

          <div className="order-1 lg:order-2 relative group">
            <div className="aspect-video overflow-hidden rounded-2xl shadow-2xl border-4 border-[#334155] transform transition-all duration-500 group-hover:scale-105">
              <Image
                src="/MLlogo.jpg"
            ...
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-[#f59e0b]/20 rounded-full blur-xl"></div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -bottom-6 -left-6 w-24 h-24 border-2 border-[#f59e0b]/30 rounded-full animate-pulse"></div>
          </div>

          <div className="space-y-6">
            <h3 className="text-4xl font-bold text-[#f59e0b] leading-tight">
              Our Mission: <br />
        ...
        >
          <div className="space-y-7 order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-200 leading-relaxed max-w-lg">
              Tiger’s Mark Corporation aims to become the preferred construction partner in the industry, and ultimately in building the future of the Philippines. We seek to be the premiere organization with the ability to supply all kinds of construction materials and equipment with our own logistics nationwide.
            </p>
            <div className="w-20 h-1 bg-[#f59e0b] rounded-full"></div>
          </div>
        ...
        >
          ...
          <div className="absolute top-20 left-10 w-20 h-20 bg-[#f59e0b]/10 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute bottom-32 right-16 w-32 h-32 bg-blue-500/10 rounded-full blur-xl"></div>

          <div className="relative z-10 max-w-5xl mx-auto space-y-16">
            <motion.div initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="space-y-6">
              <h3 className="text-6xl md:text-7xl font-black text-white leading-tight">
                How It
                <span className="block text-[#f59e0b]">Began</span>
              </h3>
              <div className="w-24 h-0.5 bg-[#f59e0b] mx-auto"></div>
            </motion.div>

            <div className="space-y-10 leading-relaxed">
              <motion.p initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }} className="text-2xl md:text-3xl text-white font-light max-w-3xl mx-auto">
              ...
              <motion.p initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }} className="text-lg text-gray-300 max-w-2xl mx-auto">
                In a small office in Quezon City, 2010, four engineers looked at the skyline and saw not just buildings — but <em className="text-[#f59e0b]">possibility</em>. They believed construction shouldn’t just follow standards — it should <strong>set them</strong>.
              </motion.p>

              <motion.p initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.8 }} className="text-lg text-gray-300 italic max-w-2xl mx-auto">
                “What if we built not just for strength… <br />
                but for soul?”
              </motion.p>

              <motion.p initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 1.0 }} className="text-lg text-gray-300 max-w-2xl mx-auto">
            ...
            <motion.div initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 1.2 }} className="pt-6">
          ...
          >
            {coreValues.map((val, index) => (
              <motion.div
                ...
                className="group bg-[#1e293b]/90 backdrop-blur-md rounded-3xl p-10 shadow-xl border border-[#334155] hover:border-[#f59e0b]/50 transition-all duration-500 min-h-[300px] flex flex-col items-center text-center"
              >
                <div className="text-[#f59e0b] text-5xl mb-5 group-hover:scale-110 transition-transform duration-300">
                  {val.icon}
                </div>
        ...
        <div className="max-w-[1600px] mx-auto grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#aboutus" className="hover:text-[#f59e0b] transition-colors">About Us</a></li>
              ...
              <li><a href="#projects" className="hover:text-[#f59e0b] transition-colors">Projects</a></li>
              <li><a href="#contact" className="hover:text-[#f59e0b] transition-colors">Contact</a></li>
              <li><a href="#FAQ" className="hover:text-[#f59e0b] transition-colors">FAQ</a></li>
            </ul>
          </div>
